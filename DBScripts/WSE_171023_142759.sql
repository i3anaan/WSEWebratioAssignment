...
alter table "public"."author_publication"   add constraint fk_author_publication_author foreign key ("author_oid") references "public"."author" ("researcher_oid");
...
create table "public"."keyword_publication" (
   ...
   "publication_oid"  int4 not null,
  primary key ("keyword_oid", "publication_oid")
);
alter table "public"."keyword_publication"   add constraint fk_keyword_publication_keyword foreign key ("keyword_oid") references "public"."keyword" ("oid");
alter table "public"."keyword_publication"   add constraint fk_keyword_publication_publica foreign key ("publication_oid") references "public"."publication" ("oid");
