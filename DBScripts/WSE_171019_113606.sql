...
alter table "public"."user_group_2"   add constraint fk_user_group_2_user foreign key ("user_oid") references "public"."user" ("oid");
alter table "public"."user_group_2"   add constraint fk_user_group_2_group foreign key ("group_oid") references "public"."group" ("oid");
